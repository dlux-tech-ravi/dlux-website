  ...
  const initGtag = () => {
    ...
    gtag('js', new Date());
    gtag('config', 'AW-11463293082'); // gtag tracking ID
  };


  const AdobeWorkfrontManagedServices = () => {
  // GA Integration
  useEffect(() => {
    initGA(); // Initialize Google Analytics
    initGtag();// Initialize gtag
    ...
    return (
      ...
      <div className='awms-pricing-section'>
          ...
          <div className='awms-pricing-terms_condition-section'>
            {/* <a href="/DLUX Managed Services - T&C (1).pdf" target="_blank" rel="noopener noreferrer"><p>Terms & conditions*</p></a>*/}
      ...
      <div className="awms-form">
            ...
            <p>DLUX is your ultimate launchpad to rocket-power your<br/>
              ...
              <div>
                ...
                <a href="tel:+61 411 048 090"> +61 411 048 090</a>
                </p>
              </div>
              <div>
  ...
  export default AdobeWorkfrontManagedServices;
